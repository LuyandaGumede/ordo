...
<body>
	...
	<div class="bHalf">
		...
		<div class="rhlaf" style="font-size: 18px;">
			...
			<div class="content">
				<a href="search.php"><button style="height: 30px; width: 100px; margin-top: 5px;font-size: 20px; margin-bottom: 10px; background-color: #2FC6E6; border-radius: 8px;">back</button></a>
                 ...
                 <h1>Search for Project Manuals:</h1>
                <hr>
                
                    <table id="search" class="table table-striped table-bordered display  responsive nowrap" style="width: 100%; font-size: 18px;">
                <thead>
                <tr style="font-size: 14px;">

                    <th style="font-size: 14px;"><strong>Project Id</strong></td>
                    <th style="font-size: 14px;"><strong>Project Name</strong></td>
                    <th class="datepicker" style="font-size: 14px;"><strong>From date</strong></td>
                    <th class="datepicker" style="font-size: 14px;"><strong>To date</strong></td>                    
                    <th style="font-size: 14px;"><strong>Project Location</strong></td>
                    <th><strong>Project File</strong></td>
                ...
                if ($result = $mysqli->query($sql)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td style="font-size: 14px;"><?php echo $row["projectId"]; ?></td>
                            <td style="font-size: 14px;"><?php echo $row["projectName"]; ?></td>
                            <td style="font-size: 14px;"><?php echo $row["projectStart"]; ?></td>
                            <td style="font-size: 14px;"><?php echo $row["projectEnd"]; ?></td>
                            <td style="font-size: 14px;"><?php echo $row["projectLocation"]; ?></td>
                     
                                   <td style="font-size: 14px;">
                                 <a href=<?php echo  str_replace(' ', '%20', "../projectuploads/".trim($row['projectFile'])) ?>>
                                 
                                     <img src="view.png" alt="Italian Trulli" style="width:40px;height:40px;"><br>
                                     <?php echo $row["projectFile"]; ?>
							...
							<td>
								<form method="post" action="proManDelete.php">
...
<th style="font-size: 14px;"><strong>Project File</strong></td>
<th style="visibility: hidden;"><strong>Delete</strong></td>
