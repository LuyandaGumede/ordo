		...
		<div class="rhlaf" >
			...
			<div class="content">
				<a href="search.php"><button style="height: 30px; width: 100px; margin-top: 5px;font-size: 20px; margin-bottom: 10px; background-color: #2FC6E6; border-radius: 8px;">back</button></a>
                 ...
                 <h1>Search for Submittal Documents:</h1>
                <hr>
                
               <table id="search" class="table table-striped table-bordered display  responsive nowrap" >
                <thead>
                <tr id="input">

                    <th><strong>Submittal Id</strong></th>
                    <th><strong>Submittal Name</strong></th>
                    <th class="datepicker"><strong>From date</strong></th>
                    <th class="datepicker"><strong>To date</strong></th>                    
                   <th><strong>Submittal File</strong></th>
                ...
                $sql = "SELECT * FROM ".$SETTINGS["data_table5"];
                ...
                if ($result = $mysqli->query($sql)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["submittalId"]; ?></td>                                                        
                            <td><?php echo $row["submittalName"]; ?></td>
                            <td><?php echo $row["submittalStart"]; ?></td>
                            <td><?php echo $row["submittalEnd"]; ?></td>
                         
                                 <td>
                                 <a href=<?php echo  str_replace(' ', '%20', "../submittaluploads/".trim($row['submittalFile'])) ?>>
                                 
                                     <img src="view.png" alt="Italian Trulli" style="width:40px;height:40px;"><br>
                                     <?php echo $row["submittalFile"]; ?>
							...
							<td>
								<form method="post" action="submDelete.php">
                ...
                <tfoot>
                <tr id="display">
                      <th><strong>Construction Id</strong></td>
                       <th><strong>Submittal Name</strong></td>
                    <th class="datepicker"><strong>From date</strong></td>
                    <th class="datepicker"><strong>To date</strong></td>                    
                   <th><strong>Submittal File</strong></td>
	<th style="visibility: hidden;"><strong>Delete</strong></td>
                </tr>
                </tfoot>
            </table>
