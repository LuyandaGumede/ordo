...
<th><strong>Drawing Id</strong></td>
 <th><strong>Name</strong></td>
                
<th><strong>Type of Drawing</strong></td>
                
    <th><strong>Type of Property</strong></td>
            
    <th><strong>Property Size</strong></td>
                 
    <th><strong>Area</strong></td>    
    
    <th><strong># Bedrooms</strong></td>
    
    <th><strong># Bathrooms</strong></td>

  <th><strong>Garage Size</strong></td>

 <th><strong>Drawing File</strong></td> 
<th style="visibility: hidden;"><strong>Delete</strong></td>
                ...
                $sql = "SELECT * FROM ".$SETTINGS["data_table4"];
                ...
                if ($result = $mysqli->query($sql)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["drawingId"]; ?></td>
                            <td><?php echo $row["name"]; ?></td>
                            <td><?php echo $row["typeDrawing"]; ?></td>
                            <td><?php echo $row["typeProperty"]; ?></td>
                            <td><?php echo $row["propertySize"]; ?></td>
                            ...
                            <td><?php echo $row["garage"]; ?></td>
                                    ...
                                    <td>
                                 <a href=<?php echo  str_replace(' ', '%20', "../drawinguploads/".trim($row['drawingFile'])) ?>>
                                 
                                     <img src="view.png" alt="Italian Trulli" style="width:40px;height:40px;"><br>
                                     <?php echo $row["drawingFile"]; ?>
							...
							<td>
								<form method="post" action="drawingsDelete.php">
