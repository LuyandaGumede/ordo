	...
	<div class="bHalf">
		...
		<div class="rhlaf" >
			...
			<div class="content">
                 ...
                 <h1>Search for Construction Documents:</h1>
        ...
        <br>
			...
			<th style="visibility: hidden;"><strong >Delete</strong></td>
                ...
                $sql = "SELECT * FROM ".$SETTINGS["data_table2"];
                ...
                if ($result = $mysqli->query($sql)) {
                    ...
                    <tr>
                            ...
                            <td><?php echo $row["constructionId"]; ?></td>
                        
                            <td><?php echo $row["constructionStart"]; ?></td>
                            <td><?php echo $row["constructionEnd"]; ?></td>
                          
                            <td>
                                <a href=<?php echo  str_replace(' ', '%20', "../constructionuploads/".trim($row['constructionFile'])) ?>>
                                     <img src="view.png" alt="Italian Trulli" style="width:40px;height:40px;"><br>
                                     <?php echo $row["constructionFile"]; ?>
                                </a>
                            </td>
							<td>
								<form method="post" action="conStructDelete.php">
                ...
                <tr>
                    ...
                    <th><strong>Project Id</strong></td>
                    <th><strong>From date</strong></td>
                    <th><strong>To date</strong></td>
                     <th><strong>Construction File</strong>
					<th style="visibility: hidden;"><strong>Delete</strong></td>
